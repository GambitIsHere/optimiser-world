      ...
      <div className="bg-gradient-to-b from-surface/60 to-bg border-b border-white/[0.06]">
        <div className="max-w-5xl mx-auto px-6 py-12">
          ...
          <div className="flex flex-wrap gap-8">
            <div>
              <p className="text-mint font-bold text-2xl">
            ...
            <div>
              ...
              <p className="text-white/60 text-sm">Upvotes</p>
            </div>
          ...
          {/* Curator */}
          <div className="mt-8 pt-8 border-t border-white/[0.06] flex items-center gap-4">
            <div className="w-12 h-12 rounded-full bg-gradient-to-br from-mint to-blue flex items-center justify-center">
      ...
      <div className="max-w-5xl mx-auto px-6 py-12">
        ...
        {collectionItems.length === 0 && (
          <div className="text-center py-12">
            <p className="text-white/60">No items in this collection</p>
          </div>
        )}
      </div>
    </div>
